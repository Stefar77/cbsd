...
#define EVENT_RECEIVE(...) void APPEND(MYNAME,MODULE_NAME)::moduleReceive(const std::string &data){ __VA_ARGS__ }
#define EVENT_THREAD(...) void APPEND(MYNAME,MODULE_NAME)::moduleThread(){ __VA_ARGS__ }

#define MODULE_HPP_START(...) class APPEND(MYNAME,MODULE_NAME): public cbsdModule { friend class cbsdModule; public: APPEND(MYNAME,MODULE_NAME)(); ~APPEND(MYNAME,MODULE_NAME)(); private: void moduleUnloading() override; bool moduleLoaded() override; void moduleThread() override; void moduleReceive(const std::string &data) override; __VA_ARGS__
...
class cbsdModule {
 ...
 public:
	...
	void			TransmitBuffered(const std::string &data);
 ...
 private:
	...
	virtual void		moduleReceive(const std::string &data)=0;
